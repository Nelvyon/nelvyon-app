...
export const FeaturedImages = ({
  ...
  // Remove translateX and hover tracking for tooltip
  useEffect(() => {
    animate(
      ".animation-container",
      {
              ...
              <AnimatePresence>
                {hoveredIndex === idx && (
                  <motion.div
                    ...
                    // Center tooltip exactly above image, with -top-full to align its bottom to the image's top, and center horizontally.
                    className="absolute left-1/2 -translate-x-1/2 -top-14 flex text-xs flex-col items-center justify-center rounded-md bg-neutral-900 z-50 shadow-xl px-4 py-2"
                  >
