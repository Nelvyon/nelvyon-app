...
const FORBIDDEN =
  /\bAIOR\b|Aiorchat|Aiorbot|themehour|themeforest|mail\.php|lorem ipsum|example\.com|Zipchat|Planora|Arsturn|EmbedAI|Leadwayz|Aurix|Bridal Makeup|Message credits|Jems Colin|Sara Lin|Mark Rivas|Contact Us|Active Users|Benefites|Cookis Policy|effortlessly|Angfuztheme|Read Articles|Before using NELVYON|NELVYON is an all-in-one|Empowering Every Industry|Manstack Developer|Trusworthy|Inspire Platform|Write a Comment\*|amicable sales|What are the plans|Akriya Sony|Work Smarter|empower teams|Automate Conversations|Research Insights|Aisha Patel|Peaceful Atmosphere/i;
