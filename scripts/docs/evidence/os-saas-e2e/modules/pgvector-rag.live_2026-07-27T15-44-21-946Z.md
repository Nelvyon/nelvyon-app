...
| Campo | Valor |
|-------|-------|
| Fecha | 2026-07-27T15:44:21.946Z |
| Run tag | ms3edali |
| Docker container | `nelvyon-local-ai-postgres` (pgvector/pgvector:pg16) @ postgresql://nelvyon_local_ai_app.mvktercdceydhaesngmv:***@aws-0-eu-west-3.pooler.supabase.com:5432/postgres |
...
| retrieve_tenant_a_own_content | critical | PASS | citations=4 sources=smoke/ms3edali/tenant-a/pricing.md,smoke/ms3edali/tenant-a/onboarding.md,smoke/ms3edali/tenant-a/refunds.md,smoke/ms3edali/tenant-a/team-roles.md confidence=0.507 |
| isolation_app_layer_a_never_sees_b | critical | PASS | citations=4 sources=smoke/ms3edali/tenant-a/pricing.md,smoke/ms3edali/tenant-a/onboarding.md,smoke/ms3edali/tenant-a/refunds.md,smoke/ms3edali/tenant-a/team-roles.md |
