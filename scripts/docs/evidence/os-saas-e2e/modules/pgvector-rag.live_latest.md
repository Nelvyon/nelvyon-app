...
| Run tag | mrzoe96w |
| Docker container | `nelvyon-local-ai-postgres` (pgvector/pgvector:pg16) @ postgresql://nelvyon_local_app:***@127.0.0.1:5434/nelvyon_local_ai |
...
| retrieve_tenant_a_own_content | critical | PASS | citations=4 sources=smoke/mrzoe96w/tenant-a/pricing.md,smoke/mrzoe96w/tenant-a/onboarding.md,smoke/mrzoe96w/tenant-a/refunds.md,smoke/mrzoe96w/tenant-a/team-roles.md confidence=0.507 |
| isolation_app_layer_a_never_sees_b | critical | PASS | citations=4 sources=smoke/mrzoe96w/tenant-a/pricing.md,smoke/mrzoe96w/tenant-a/onboarding.md,smoke/mrzoe96w/tenant-a/refunds.md,smoke/mrzoe96w/tenant-a/team-roles.md |
