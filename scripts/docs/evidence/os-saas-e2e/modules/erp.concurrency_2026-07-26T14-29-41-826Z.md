...
| Campo | Valor |
|-------|-------|
| Fecha | 2026-07-26T14:29:41.826Z |
| Verdict | **ALL_PASS** |
...
- PASS `seed.inventory`: sku=CONC-6185e15d loc=277a0939-79ea-4a76-ae59-29f15b13b90e
- PASS `conc.receive.same_key`: stock=10 statuses=201,201 moveIds=3f0434cc-5fa4-432f-9528-e55924d548fa|3f0434cc-5fa4-432f-9528-e55924d548fa
- PASS `conc.receive.distinct`: +15 stock=25 responses_okish=3
- PASS `conc.reserve.parallel`: avail=0 reserved=25 a=400/INSUFFICIENT_STOCK b=201/ok
- PASS `conc.pr.same_key`: id=f8228c07-6a88-4abf-9612-9a3261144935 a=201 b=201
