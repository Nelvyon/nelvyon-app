...
| Campo | Valor |
|-------|-------|
| Fecha | 2026-07-27T16:42:45.027Z |
| Run tag | ms3ggjey |
...
| retrieve_tenant_a_own_content | critical | PASS | citations=1 sources=smoke/ms3ggjey/tenant-a/pricing.md confidence=0.612 |
| isolation_app_layer_a_never_sees_b | critical | PASS | citations=0 sources=none |
