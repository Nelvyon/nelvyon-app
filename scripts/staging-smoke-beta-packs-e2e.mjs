/**
 * Staging E2E — 5 certified beta packs (social, content, cro, analytics, brand).
 * Usage: node scripts/staging-smoke-beta-packs-e2e.mjs [--skip-wait] [--only=social|content|cro|analytics|brand]
 */
...
const PACKS = [
  ...
  },
  {
    ...
    titles: [
      "Landing contenido",
      "Keywords contenido",
      "Plan editorial 90 días",
      "Guía de mensajes de marca",
      "Informe ejecutivo",
    ],
  },
  {
    ...
    titles: [
      "Landing CRO",
      "Informe fricción SEO",
      "Auditoría de landing",
      "Plan A/B test 30 días",
      "Informe ejecutivo",
    ],
  },
  {
...
async function main() {
  ...
  if (!SKIP_WAIT) {
    await waitForStagingDeploy(BASE, { skipWait: false, label: "beta-packs-e2e" });
