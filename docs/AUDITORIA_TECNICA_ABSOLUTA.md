...
> Fecha: **2026-07-25** (ADR-061 VERIFIED staging) · tip live **`9e931f08`** · deploy **`794662d7` SUCCESS** · mig **519+520** · restart **ALL_PASS** · claimReady false  
...
| Dimensión | Estado |
|-----------|--------|
| VERDE VERIFICADO | influencers · ads_attribution (core) · community_publish (sim) · telephony (sim) · oauth (mock) · marketplace · ERP 26–29+35 (Postgres SSOT + staging restart) · RAG Docker · PWA Chrome · HA single-region · obs local · legacy (0 deletes) · localization UI FULL |
| PREPARADO OFF | Railway pgvector · private_ai_canary · paid observability · social oficial · industry sector pack · ERP relational dual-write 519 |
...
| BLOQUEO CEO | IA prod canary · OpenClaw prod · OpenAI · payouts · 8 cuentas oficiales · **prod ERP migrate (CTO)** |
...
- Staging tip **`9e931f08`** · deploy **`794662d7` SUCCESS** · `_migrations` **519+520**
- `erp.persistence_restart_latest.md` **ALL_PASS** · snapshot purchases v3 · RLS on
- `erp.cores_synthetic_latest.md` **ALL_PASS**
- P0 process-memory SSOT risk **closed + staging survival VERIFIED**
- `claimReady: false` · **NOT READY**
- Sin OAuth real inventado · sin Odoo · sin multi-región activa · Railway pgvector **PREPARED_OFF** · **no** prod ERP migrate sin CTO
...
1. **CTO go-ahead** before prod ERP migrate  
...
- `docs/CHANGELOG.md`
- evidencias en `scripts/docs/evidence/os-saas-e2e/modules/` (incl. `erp.persistence_restart_latest.md`)

No se elimina historial; esta sección prioriza el **ADR-061 2026-07-25 VERIFIED staging** como SSOT operativo actual.
