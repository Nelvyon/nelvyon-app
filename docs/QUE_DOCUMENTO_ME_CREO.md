...
|---|---|---|
| `GENERADO` | 7 | lo reescribe un script o una prueba en cada ejecución. Es el único que no puede quedarse obsoleto |
| `VIGENTE` | 46 | a mano, tocado en los últimos 30 días |
| `HISTORICO` | 121 | a mano, sin tocar desde hace más. Memoria del proyecto, no estado actual |
...
| [BLOQUE_3_LINEA_BASE.md](BLOQUE_3_LINEA_BASE.md) — BLOQUE 3 — línea base | 6 | 56 |
| [FICHAS_ALCANCE_DE_PRODUCTO.md](FICHAS_ALCANCE_DE_PRODUCTO.md) — Las 8 funciones con deriva esquema↔código — fichas para decidir alcance | 6 | 160 |
| [HANDOFF_AISLAMIENTO.md](HANDOFF_AISLAMIENTO.md) — Handoff — cierre del aislamiento multiinquilino | 6 | 1335 |
| [PLAN_LIMPIEZA_FIXTURES.md](PLAN_LIMPIEZA_FIXTURES.md) — Plan de limpieza de datos de certificación | 6 | 97 |
| [NELVYON_CLOSURE_STATE.md](NELVYON_CLOSURE_STATE.md) — NELVYON — ESTADO OPERATIVO DE CIERRE | 15 | 472 |
| [NELVYON_RELEASE_CANDIDATE_REPORT.md](NELVYON_RELEASE_CANDIDATE_REPORT.md) — NELVYON — Informe de Release Candidate | 15 | 179 |
| [TODO.md](TODO.md) — TODO | 16 | 704 |
| [ARCHITECTURE_LOCAL_AI_RUNTIME.md](ARCHITECTURE_LOCAL_AI_RUNTIME.md) — ARCHITECTURE — Local AI runtime for agents (cost = 0) | 21 | 193 |
| [ELITE_QUALITY_FINALIZATION.md](ELITE_QUALITY_FINALIZATION.md) — ELITE_QUALITY_FINALIZATION | 21 | 61 |
...
| [OPS_STRIPE_PROD.md](OPS_STRIPE_PROD.md) — OPS — Stripe producción (checklist humana mínima) | 30 | 38 |
...
| [NELVYON_MASTER_CONTEXT.md](NELVYON_MASTER_CONTEXT.md) — NELVYON — MASTER CONTEXT (Biblia oficial) | 31 | 1821 |
| [NELVYON_OBSERVABILITY_REALITY.md](NELVYON_OBSERVABILITY_REALITY.md) — NELVYON — Observabilidad: qué está **demostrado en este repo** vs qué queda **fuera** | 31 | 54 |
...
| [OS_FLOW_AUDIT.md](OS_FLOW_AUDIT.md) — OS Production Flows Audit — 2026-07-22 | 38 | 54 |
| [PROPOSAL_QUALITY_ROUTING_LOCAL.md](PROPOSAL_QUALITY_ROUTING_LOCAL.md) — PROPOSAL — Quality routing local (3b vs 8b) | 38 | 48 |
| [AI_CONTEXT.md](AI_CONTEXT.md) — AI_CONTEXT — Contexto técnico completo NELVYON | 39 | 219 |
| [CONSTITUTION_NELVYON_AI.md](CONSTITUTION_NELVYON_AI.md) — CONSTITUCIÓN NELVYON — IA Privada Especializada | 39 | 112 |
| [NELVYON_BRAIN_KNOWLEDGE.md](NELVYON_BRAIN_KNOWLEDGE.md) — NELVYON BRAIN — Cobertura de conocimiento (evidencia) | 39 | 55 |
| [OPS_SHARED_MEMORY_514.md](OPS_SHARED_MEMORY_514.md) — OPS — Shared Memory migration 514 (+ RLS 515) | 39 | 62 |
| [CIERRE_FINAL_PRIORITARIO.md](CIERRE_FINAL_PRIORITARIO.md) — CIERRE FINAL PRIORITARIO - Informe (2026-07-20) | 40 | 139 |
| [SPRINT_FINAL_ABSOLUTO.md](SPRINT_FINAL_ABSOLUTO.md) — SPRINT FINAL ABSOLUTO — Estado | 40 | 51 |
| [TEST_SKIPS.md](TEST_SKIPS.md) — Vitest skipped tests — criterios de activación (SSOT) | 40 | 15 |
| [AGENT_CAPABILITY_MATRIX.md](AGENT_CAPABILITY_MATRIX.md) — AGENT CAPABILITY MATRIX | 41 | 44 |
| [AGENT_EVALUATION_FRAMEWORK.md](AGENT_EVALUATION_FRAMEWORK.md) — AGENT EVALUATION FRAMEWORK | 41 | 65 |
| [AGENT_TOOL_PERMISSION_MATRIX.md](AGENT_TOOL_PERMISSION_MATRIX.md) — AGENT TOOL PERMISSION MATRIX | 41 | 68 |
| [AGENT_WORKFLOW_CATALOG.md](AGENT_WORKFLOW_CATALOG.md) — AGENT WORKFLOW CATALOG | 41 | 47 |
| [AGENT_WORKFORCE_INVENTORY.md](AGENT_WORKFORCE_INVENTORY.md) — AGENT WORKFORCE INVENTORY — NELVYON | 41 | 142 |
| [AGENT_WORKFORCE_ORGANIZATION.md](AGENT_WORKFORCE_ORGANIZATION.md) — AGENT WORKFORCE ORGANIZATION | 41 | 83 |
| [AUTONOMOUS_RUNTIME.md](AUTONOMOUS_RUNTIME.md) — AUTONOMOUS RUNTIME — Orchestrator Daemon (Bloque C) | 41 | 125 |
| [AUTONOMOUS_WORKFORCE_CERT.md](AUTONOMOUS_WORKFORCE_CERT.md) — AUTONOMOUS WORKFORCE CERT — Gate final | 41 | 67 |
| [CURSOR_OPEN_SOURCE_INTEGRATION_AUDIT.md](CURSOR_OPEN_SOURCE_INTEGRATION_AUDIT.md) — CURSOR / OPEN SOURCE INTEGRATION AUDIT | 41 | 54 |
| [FINAL_ELITE_CLOSURE.md](FINAL_ELITE_CLOSURE.md) — FINAL ELITE CLOSURE — Informe de cierre técnico del repositorio | 41 | 95 |
| [MASTER_OPEN_SOURCE_LICENSES.md](MASTER_OPEN_SOURCE_LICENSES.md) — MASTER — Licencias Open Source NELVYON | 41 | 179 |
| [MASTER_OPEN_SOURCE_SECURITY.md](MASTER_OPEN_SOURCE_SECURITY.md) — MASTER — Seguridad Open Source NELVYON | 41 | 95 |
| [NELVYON_LABS.md](NELVYON_LABS.md) — NELVYON-LABS — Laboratorio tecnológico | 41 | 107 |
| [NELVYON_LABS_ARCHITECTURE.md](NELVYON_LABS_ARCHITECTURE.md) — NELVYON-LABS — Arquitectura de aprovechamiento | 41 | 41 |
| [NELVYON_LABS_LICENSE_FINAL.md](NELVYON_LABS_LICENSE_FINAL.md) — NELVYON-LABS — Licencias (decisión final) | 41 | 123 |
| [NELVYON_LABS_MASTER_CLOSURE.md](NELVYON_LABS_MASTER_CLOSURE.md) — NELVYON-LABS — BLOQUE MAESTRO CERRADO | 41 | 75 |
| [NELVYON_LABS_SECURITY_FINAL.md](NELVYON_LABS_SECURITY_FINAL.md) — NELVYON-LABS — Seguridad (gates de preparación) | 41 | 38 |
| [NELVYON_LABS_SUMMARY.md](NELVYON_LABS_SUMMARY.md) — NELVYON-LABS — Resumen oficial | 41 | 103 |
| [OS_SAAS_FUNCTIONAL_INVENTORY.md](OS_SAAS_FUNCTIONAL_INVENTORY.md) — OS + SaaS — Inventario funcional | 41 | 107 |
| [OS_SAAS_SECURITY_AUDIT.md](OS_SAAS_SECURITY_AUDIT.md) — OS + SaaS — Auditoría de seguridad (funcional) | 41 | 49 |
| [PHASE2_AGENTS.md](PHASE2_AGENTS.md) — PHASE2 — Agentes especialistas (diseño) | 41 | 16 |
| [PHASE2_AI_PANEL.md](PHASE2_AI_PANEL.md) — PHASE2 — Panel IA (diseño) | 41 | 25 |
| [PHASE2_ARCHITECTURE.md](PHASE2_ARCHITECTURE.md) — PHASE2_ARCHITECTURE — SSOT IA (nota workforce) | 41 | 37 |
| [PHASE2_AUTOMATIONS.md](PHASE2_AUTOMATIONS.md) — PHASE2 — Automatizaciones (diseño) | 41 | 23 |
| [PHASE2_MCP.md](PHASE2_MCP.md) — PHASE2 — MCP Productivo | 41 | 42 |
| [PHASE2_MCP_ARCHITECTURE.md](PHASE2_MCP_ARCHITECTURE.md) — PHASE2 — MCP Architecture | 41 | 46 |
| [PHASE2_MCP_BENCHMARK.md](PHASE2_MCP_BENCHMARK.md) — PHASE2 — MCP Benchmark | 41 | 31 |
| [PHASE2_MCP_SECURITY.md](PHASE2_MCP_SECURITY.md) — PHASE2 — MCP Security | 41 | 36 |
| [PHASE2_MCP_TOOLS.md](PHASE2_MCP_TOOLS.md) — PHASE2 — MCP Tools | 41 | 37 |
| [PHASE2_MODEL_ROUTER.md](PHASE2_MODEL_ROUTER.md) — Fase 2 — Model Router NELVYON | 41 | 149 |
| [PHASE2_OPENCLAW.md](PHASE2_OPENCLAW.md) — PHASE2 — OpenClaw | 41 | 31 |
| [PHASE2_RAG_UNIFIED.md](PHASE2_RAG_UNIFIED.md) — PHASE2 — RAG unificado (KI-005) | 41 | 37 |
| [PHASE2_ROUTER_ARCHITECTURE.md](PHASE2_ROUTER_ARCHITECTURE.md) — Arquitectura — Model Router NELVYON | 41 | 56 |
| [PHASE2_ROUTER_BENCHMARK.md](PHASE2_ROUTER_BENCHMARK.md) — Benchmark — Model Router | 41 | 80 |
| [PHASE2_ROUTER_SAAS_WIRING.md](PHASE2_ROUTER_SAAS_WIRING.md) — PHASE2 — Router → SaaS PrivateAI (cerrado) | 41 | 63 |
| [PHASE2_ROUTER_SECURITY.md](PHASE2_ROUTER_SECURITY.md) — Seguridad — Model Router | 41 | 48 |
| [PHASE2_SECURITY_MODEL.md](PHASE2_SECURITY_MODEL.md) — PHASE 2 — Modelo de seguridad IA local | 41 | 93 |
| [PHASE2_SHARED_MEMORY.md](PHASE2_SHARED_MEMORY.md) — PHASE2 — Shared Memory (runtime — ADR-024) | 41 | 51 |
| [PHASE2_SPECIALIZATION_CERTIFICATION.md](PHASE2_SPECIALIZATION_CERTIFICATION.md) — Fase 2 — Certificación especialización NELVYON | 41 | 367 |
| [PRIVATE_AI_PHASE2.md](PRIVATE_AI_PHASE2.md) — Fase 2 — IA privada Nelvyon | 41 | 25 |
| [PRODUCTION_CERTIFICATION_REPORT.md](PRODUCTION_CERTIFICATION_REPORT.md) — NELVYON — Informe de certificación final de producción (2026-07-17) | 41 | 147 |
| [PRODUCTION_SECRETS.md](PRODUCTION_SECRETS.md) — Producción — Secretos y variables (Fuente de verdad) | 41 | 196 |
| [QUALITY_STANDARD.md](QUALITY_STANDARD.md) — Estándar definitivo de calidad — NELVYON | 41 | 45 |
...
| [ARCHITECTURE.md](ARCHITECTURE.md) — ARCHITECTURE — Arquitectura real NELVYON | 51 | 163 |
| [SMOKE_GATES.md](SMOKE_GATES.md) — Smoke & CI Gates — Nelvyon | 56 | 47 |
| [STRIPE_BILLING_P0.md](STRIPE_BILLING_P0.md) — Stripe Billing P0 — Checkout + Webhook E2E | 56 | 167 |
| [MANUAL_OPS_ONLY.md](MANUAL_OPS_ONLY.md) — Manual ops only — Nelvyon producción | 59 | 64 |
| [NELVYON_QUALITY_SCORE.md](NELVYON_QUALITY_SCORE.md) — NELVYON — Puntuación de calidad real (0–10) | 59 | 45 |
| [PARITY_GHL_HUBSPOT.md](PARITY_GHL_HUBSPOT.md) — Paridad Nelvyon SaaS vs GoHighLevel + HubSpot | 59 | 63 |
| [OS_AGENT_AUDIT_TRAIL.md](OS_AGENT_AUDIT_TRAIL.md) — OS Agent Audit Trail (O28) | 63 | 46 |
| [OS_AGENT_DATA.md](OS_AGENT_DATA.md) — OS Agent Data — Semrush / DataForSEO in production (O21) | 63 | 62 |
| [OS_BRIEF_DIFF_RERUN.md](OS_BRIEF_DIFF_RERUN.md) — OS Brief Diff & Re-run (O29) | 63 | 45 |
| [OS_COMPETITOR_GAP.md](OS_COMPETITOR_GAP.md) — OS Competitor Gap Pack (O24) | 63 | 57 |
| [OS_DELIVERY_CERTIFICATE.md](OS_DELIVERY_CERTIFICATE.md) — OS Delivery Certificate (O23) | 63 | 57 |
| [OS_GATE_RUNBOOK.md](OS_GATE_RUNBOOK.md) — OS Pack Gate — Runbook (O22) | 63 | 61 |
| [OS_LEARNING.md](OS_LEARNING.md) — OS Learning Loop — GA4 → Seed Selector Weights | 63 | 92 |
| [OS_REGULATED_SECTOR_SHIELD.md](OS_REGULATED_SECTOR_SHIELD.md) — OS Regulated Sector Shield (O27) | 63 | 65 |
| [OS_RETAINER_AUTOPILOT.md](OS_RETAINER_AUTOPILOT.md) — OS Retainer Autopilot v2 (O25) | 63 | 52 |
| [OS_TEMPLATE_DNA.md](OS_TEMPLATE_DNA.md) — OS Template DNA (O26) | 63 | 45 |
...
| [PARTNERS_P2_REBILLING_PORTAL_WL.md](PARTNERS_P2_REBILLING_PORTAL_WL.md) — P2 — Rebilling Stripe Connect + White-label Portal | 75 | 303 |
| [PARTNERS_WHITELABEL_PROGRAM.md](PARTNERS_WHITELABEL_PROGRAM.md) — Programa Partners / White-Label SaaS & Agencia — Diseño v1 | 75 | 258 |
| [PRODUCTION_READINESS_FINAL.md](PRODUCTION_READINESS_FINAL.md) — NELVYON — Production Readiness Final | 82 | 325 |
| [AUTONOMOUS_SERVICES_MODE.md](AUTONOMOUS_SERVICES_MODE.md) — NELVYON — Autonomous Services Mode | 83 | 689 |
| [OS_PRODUCTION_GO_LIVE_CHECKLIST.md](OS_PRODUCTION_GO_LIVE_CHECKLIST.md) — OS Production Go-Live Checklist — Lunes | 83 | 325 |
