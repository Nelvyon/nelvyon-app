...
> Actualizado: **2026-07-31** — W3CRM Fase 2 módulo 9 Facturación/pagos/suscripciones DONE · módulo 8 Funnels/formularios/landing pages DONE · módulo 7 Marketing/redes sociales DONE · módulo 6 Calendario/citas DONE · módulo 5 Automatizaciones/workflows DONE (builder clásico + editor visual) · módulo 4 Comunicación DONE · módulo 3 IA NELVYON DONE · módulo 2 CRM/Pipeline DONE · Fase 1 prod DONE · Fase 2 prep DONE · `claimReady: false`
...
- [ ] **P2 — validar visualmente en staging** el módulo Facturación/pagos/suscripciones con sesión autenticada real (mismo bloqueo de `DATABASE_URL` local que módulos 2–8)
- [ ] **W3CRM Fase 2 — siguiente módulo (automático):** Analítica, informes y exportaciones → Administración/usuarios/roles/permisos/auditoría → … (orden completo en `docs/ops/W3CRM_MIGRATION_PLAN.md` §7)
