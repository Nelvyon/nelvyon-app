...
> **Version** `1.4.0` · ADR-057 Blocks 11–25 · tip **TBA** · `claimReady: false` · **NOT READY**  
...
| Estado | Servicios (v1.4.0) |
|--------|-------------------|
| IMPLEMENTED_VERIFIED | growth packs · automations · reputation · SM-MCP synthetic · telephony_core · oauth_multitenant · integrations_marketplace · private_vector_rag · + cores Blocks 13–15/19–23 (ver matriz) |
| PREPARED_OFF | influencers_pr · private_ai_canary_prep · nelvyon_official_social · mobile (contract verified) |
| BLOCKED_EXTERNAL | real telephony · real ads spend/OAuth · real publish · App Store/Play · multi-region pgvector live |
| BLOCKED_LEGAL | mass-send · claimReady |
| BLOCKED_CEO | private_ai_canary_prep prod activation |

## Servicios (baseline + ADR-057)
...
| **influencers_pr** (Block 12) | svc_social_creative | PREPARED_OFF / beta | unit+kickoff wired · staging E2E opcional |
...
| **private_vector_rag** (Block 24) | global_security_compliance | IMPLEMENTED_VERIFIED (synthetic) | pgvector Docker PREPARED_OFF |
...
- Evidencia: `pwa.cert_latest.md` · `private-rag.synthetic_latest.md` · `backend/agency` **249 PASS** · `tsc` **0**
