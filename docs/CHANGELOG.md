...
|------|--------|-------------|
| Gobernanza / CEO | **ADR-067 CEO 1 SÍ / 2–4 NO** | #1 gate migrate **CEO-ACK** (sin migrate ahora) · #2 dual-write NO · #3 RAG apply NO · #4 canary IA NO · regresión soft-flag approve · ERP A/B ALL_PASS · `points_1_4_ceo_decision_latest.md` · `claimReady: false` |
