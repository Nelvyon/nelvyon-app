...
| 01:45 | `wait-for-deploy.mjs` | Fix | `DEPLOY_WAIT_SOFT` — proceed on health OK si SHA no match (scripts-only push) |
| 18:55 | CI Staging Elite Gate | FAIL | deploy SHA timeout run `29042589610` |
