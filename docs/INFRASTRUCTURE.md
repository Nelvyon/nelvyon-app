...
| **Railway prod** | ✅ | tip **`5a36809c`** · 519/520 kept · **ADR-064 migrate gate** · IA keys ABSENT |
| **Railway staging** | ✅ | auto-migrate · ERP VERIFIED · tip live `5a36809c` hasta deploy gate |
