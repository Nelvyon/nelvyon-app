...
Todas las migraciones 001–507 están en main. Railway `releaseCommand` ejecuta `migrate.ts` en cada deploy (503–507: private-ai scaffold, activation reports, marketing leads, FastAPI runtime schemas).
