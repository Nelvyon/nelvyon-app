...
/** Backend origin for dev proxy. Use 127.0.0.1 (not localhost) so Set-Cookie + browser origin stay aligned. */
const DEV_API_PROXY_TARGET =
  process.env.VITE_PROXY_API_TARGET || 'http://127.0.0.1:8000';
