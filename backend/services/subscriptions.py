...
class SubscriptionsService:
    ...
    async def get_by_id(
        ...
        Optional filters: user_id (legacy row owner), workspace_id (billing titular).
        """
        try:
            ...
            if workspace_id is not None:
                query = query.where(Subscriptions.workspace_id == workspace_id)
    ...
    async def get_list(
        ...
        Prefer workspace_id for billing-titular queries; user_id filters by row initiator (legacy).
        """
        try:
            ...
            if workspace_id is not None:
                query = query.where(Subscriptions.workspace_id == workspace_id)
                count_query = count_query.where(Subscriptions.workspace_id == workspace_id)
    ...
    async def update(
        ...
        """Update subscriptions (scoped by user_id and/or workspace_id when provided)."""
        try:
