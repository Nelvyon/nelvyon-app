...
export const AGENT_CAPABILITY_MATRIX: AgentCapabilityRow[] = [
  ...
  { id: "product", domain: "product", runtimeReady: true, tools: ["memory", "rag", "reports"], memory: true, rag: true, evalCovered: true, workflowCovered: true, notes: "Roadmap/discovery; pricing gated" },
  ...
  { id: "social_media", domain: "social", runtimeReady: true, tools: ["memory", "reports", "rag"], memory: true, rag: true, evalCovered: true, workflowCovered: true, notes: "Calendar/draft; publish gated" },
  ...
  { id: "devops", domain: "engineering", runtimeReady: true, tools: ["rag", "reports", "audit", "memory"], memory: true, rag: true, evalCovered: true, workflowCovered: true, notes: "Runbooks; no prod deploy" },
