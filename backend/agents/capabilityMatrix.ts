...
export const AGENT_CAPABILITY_MATRIX: AgentCapabilityRow[] = [
  ...
  { id: "google_ads", domain: "ads", runtimeReady: true, tools: ["reports", "memory"], memory: true, rag: false, evalCovered: false, workflowCovered: false, notes: "Advise-only; sandbox not in elite 10" },
  { id: "meta_ads", domain: "ads", runtimeReady: true, tools: ["reports", "memory"], memory: true, rag: false, evalCovered: false, workflowCovered: false, notes: "Same" },
  { id: "tiktok_ads", domain: "ads", runtimeReady: true, tools: ["reports", "memory"], memory: true, rag: false, evalCovered: false, workflowCovered: false, notes: "Same" },
  ...
  { id: "finance", domain: "finance", runtimeReady: true, tools: ["billing", "reports"], memory: false, rag: false, evalCovered: true, workflowCovered: true, notes: "Cost in proposals" },
  { id: "portal_client", domain: "cs", runtimeReady: true, tools: ["memory", "rag", "reports"], memory: true, rag: true, evalCovered: true, workflowCovered: false, notes: "Portal advise; no elite workflow yet" },
