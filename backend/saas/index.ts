export {
  ...
  normalizeText as normalizeTruthText,
  evaluateClaims as evaluateTruthClaims,
  evaluateEmailSubject,
  evaluateAdsCopy,
  computeTruthStatus,
  DECEPTIVE_SUBJECT_PATTERNS,
  ADS_MIN_HEADLINE_LEN,
  ADS_MIN_DESCRIPTION_LEN,
  type TruthChannel,
  type TruthStatus,
  type TruthCheck,
...
export {
  ...
  OsBriefDiffError,
  getOsBriefDiffRerunService,
  resetOsBriefDiffRerunServiceForTests,
  MATERIAL_INTAKE_FIELDS,
  diffIntake,
  isMaterialDiff,
  mergeIntake,
  normalizeIntakeValue,
  type BriefDiffStatus,
  type BriefDiffChange,
  type BriefDiffChangeKind,
  type BriefDiffRecord,
  type BriefDiffSummary,
  type DiffPackRun,
  type DiffPackRunPort,
  type DiffRunnerPort,
  type OsBriefDiffErrorCode,
...
export {
  ...
  recommendPack,
  buildBriefPatch,
  type AgentDataPort as GapAgentDataPort,
  type PackLaunchPort as GapPackLaunchPort,
  type CompetitorGap,
  type CompetitorGapRun,
  type GapSummary,
  type GapSeverity,
  type GapCategory,
  type GapRunStatus,
