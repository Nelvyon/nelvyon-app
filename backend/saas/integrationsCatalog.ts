...
export const INTEGRATIONS_CATALOG: IntegrationConnector[] = [
  // ── Ads ──────────────────────────────────────────────────────────────────
  {
    ...
    envKeys: ["META_APP_ID|META_CLIENT_ID", "META_APP_SECRET|META_CLIENT_SECRET"],
    relatedRoute: "/saas/publicidad", status: "beta",
  },
  {
  ...
  },
  {
    ...
    category: "ads", connectionType: "oauth",
    envKeys: ["TIKTOK_APP_ID|TIKTOK_CLIENT_ID|TIKTOK_CLIENT_KEY", "TIKTOK_APP_SECRET|TIKTOK_CLIENT_SECRET"],
    relatedRoute: "/saas/publicidad", status: "beta",
  },
  {
  ...
  },
  {
    ...
    relatedRoute: "/saas/whatsapp", status: "beta",
  },
  {
