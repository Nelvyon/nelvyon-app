...
/** Exported so callers can build a safe manifest fallback (e.g. the API route) without an empty `icons: []`, which breaks PWA installability. */
export const DEFAULT_ICONS: PwaIcon[] = [
