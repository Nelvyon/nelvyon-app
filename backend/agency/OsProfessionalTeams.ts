...
export const OS_PROFESSIONAL_TEAMS: readonly OsTeamDefinition[] = [
  ...
  },
  {
    ...
    title: "Redes sociales completas por cliente",
    kind: "specialist",
    ...
    roles: [
      {
        ...
        responsibilities: ["Objetivos", "canales", "público", "posicionamiento", "plan mensual"],
        permissions: ["draft", "assisted"],
      ...
      },
      {
        ...
        mapsToAgentIds: ["marketing", "seo"],
        responsibilities: ["Oportunidades sector", "benchmark competencia"],
        permissions: ["observe", "draft"],
        forbidden: [...forbidSpend, "publish_post"],
      },
      {
        roleId: "content_planner",
        title: "Content planner",
        mapsToAgentIds: ["content", "social_media_premium"],
        responsibilities: ["Calendario editorial por red y objetivo"],
        permissions: ["draft", "assisted"],
        forbidden: [...forbidSpend, "publish_post"],
      },
      {
        ...
        responsibilities: ["Hooks", "guiones", "copies", "CTA", "hashtags", "variantes"],
        permissions: ["draft"],
        forbidden: [...forbidSpend, "publish_post", "false_promise"],
      },
      {
        roleId: "creative_director",
        title: "Director creativo / diseñador",
        mapsToAgentIds: ["branding_premium", "social_media_premium"],
        responsibilities: ["Línea visual", "carruseles", "creatividades", "coherencia marca"],
        permissions: ["draft", "assisted"],
        forbidden: [...forbidSpend, "paid_render_without_approval", "publish_post"],
      },
      {
        roleId: "video_team",
        title: "Equipo de vídeo",
        mapsToAgentIds: ["content", "social_media"],
        responsibilities: ["Guion", "storyboard", "escenas", "edición", "subtítulos", "formatos"],
        permissions: ["draft"],
        forbidden: [...forbidSpend, "paid_render_without_approval", "publish_post"],
      },
      {
        ...
        responsibilities: ["Respuestas preparadas", "clasificación comentarios", "escalados"],
        permissions: ["draft", "assisted"],
        forbidden: [...forbidSpend, "sensitive_auto_reply", "mass_dm", "publish_without_approval"],
      },
      {
        roleId: "paid_social",
        title: "Especialista paid social (PREPARED_OFF)",
        mapsToAgentIds: ["meta_ads", "ads_premium"],
        responsibilities: ["Kit paid OFF hasta OAuth + cuenta + presupuesto CEO"],
        permissions: ["draft"],
        forbidden: [...forbidSpend, "oauth_connect", "paid_spend", "publish_ads"],
      },
      {
        roleId: "social_analyst",
        title: "Analista social",
        mapsToAgentIds: ["reporting"],
        responsibilities: ["Alcance", "retención", "leads", "ventas", "sentimiento", "experimentos"],
        permissions: ["observe", "draft"],
        forbidden: [...forbidSpend],
      },
      {
