...
export const ORPHAN_CLASSIFICATION: readonly OrphanClassEntry[] = [
  ...
  { path: "docs/CONTRATO_DE_SERVICIO.md", disposition: "index", domain: "nelvyon", priority: 0, title: "Contrato de cada servicio", reason: "Lo que hace falta para poder prometer cada servicio, derivado del arbol" },
  { path: "docs/INVENTARIO_DE_CONECTORES.md", disposition: "index", domain: "nelvyon", priority: 0, title: "Que se puede conectar hoy", reason: "Estado real de los 16 conectores, contrastado contra el arbol y no contra su ficha" },
  { path: "docs/AUDITORIA_DE_COSTE.md", disposition: "index", domain: "finance_operations", priority: 0, title: "Auditoria de coste", reason: "Que se puede tocar sin que suba la factura; clasificacion por clase de coste" },
  { path: "docs/QUE_DOCUMENTO_ME_CREO.md", disposition: "index", domain: "nelvyon", priority: 0, title: "Que documento me creo", reason: "Cuales de los 179 documentos describen el sistema de hoy y cuales son historia" },
  { path: "docs/PREFLIGHT_DEL_DESPLIEGUE.md", disposition: "index", domain: "nelvyon", priority: 1, title: "Preflight del despliegue", reason: "Que trae el despliegue pendiente: areas, variables, orden migracion/deploy" },
  { path: "docs/CAMBIO_EN_PRODUCCION.md", disposition: "index", domain: "nelvyon", priority: 1, title: "Que cambiaria en produccion", reason: "Diferencia exacta de esquema entre produccion y la referencia migrada" },
  { path: "docs/SI_FALLA_UNA_MIGRACION.md", disposition: "index", domain: "nelvyon", priority: 1, title: "Si falla una migracion a mitad", reason: "Atomicidad de las pendientes y que hacer si falla la N de 21" },
  { path: "docs/AGUANTAN_LOS_DATOS.md", disposition: "index", domain: "nelvyon", priority: 1, title: "Aguantan los datos actuales", reason: "Si los datos de hoy caben en las restricciones pendientes; la comprobacion que falto antes de la 579" },
  ...
  { path: "docs/CIERRE_DE_PENDIENTES.md", disposition: "index", domain: "nelvyon", priority: 1, title: "Cierre de pendientes post-certificacion", sourceType: "official_doc", reason: "Que resulto ser cada uno de los 8 bloqueos al reevaluarlos contra el arbol, los seis defectos reales que aparecieron al mirarlos, y lo certificado con sus mutaciones" },
  { path: "docs/LO_QUE_TIENE_QUE_HACER_EL_FUNDADOR.md", disposition: "index", domain: "nelvyon", priority: 0, title: "Lo que solo puede hacer el fundador", sourceType: "runbook", reason: "Los seis pasos que quedan tras el cierre de pendientes, con los comandos exactos: variables, primer administrador, aprobacion de migraciones, cutover del rol web, verificaciones contra produccion y las dos decisiones que quedan" },
