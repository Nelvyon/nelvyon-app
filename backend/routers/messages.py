...
async def query_messagess(
    ...
    """Query messages scoped to active workspace (tenant isolation)."""
...
async def query_messagess_all(
    ...
    """Listado amplio dentro del workspace (operator + módulo helpdesk)."""
    logger.debug(f"Querying messagess /all: query={query}, sort={sort}, skip={skip}, limit={limit}, fields={fields}")
...
async def get_messages(
    ...
    """Get a single message by ID (workspace-scoped)."""
...
async def update_messagess_batch(
    ...
    """Update multiple messagess in a single request (operator + helpdesk + tenant)."""
...
async def update_messages(
    ...
    """Update an existing messages (operator + helpdesk + tenant)."""
...
async def delete_messagess_batch(
    ...
    """Delete multiple messagess by their IDs (operator + helpdesk + tenant)."""
...
async def delete_messages(
    ...
    """Delete a single messages by ID (operator + helpdesk + tenant)."""
