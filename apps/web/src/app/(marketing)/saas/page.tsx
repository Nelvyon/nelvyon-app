    ...
    <main style={{ paddingTop: "68px" }}>
      ...
      <section style={{ backgroundColor: "#f8faff", padding: "24px 0" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 24px" }}>
          <div style={{ background: "linear-gradient(135deg, #07122a 0%, #0084fc 100%)", borderRadius: "16px", padding: "48px", display: "flex", gap: "32px", justifyContent: "center", flexWrap: "wrap" }}>
            {heroStats.map((stat) => (
