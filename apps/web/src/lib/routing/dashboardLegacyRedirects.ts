...
const DASHBOARD_PREFIX_REDIRECTS: ReadonlyArray<readonly [string, string]> = [
  ...
  ["/dashboard/local-growth", "/os/packs/local-growth/report"],
  ["/dashboard/ecommerce-growth", "/os/packs/ecommerce-growth/report"],
  ["/dashboard/saas-b2b-growth", "/os/packs/saas-b2b-growth/report"],
  ["/dashboard/social-calendar", "/os/packs/social-calendar/report"],
  ["/dashboard/content-strategy", "/os/packs/content-strategy/report"],
  ["/dashboard/cro-audit", "/os/packs/cro-audit/report"],
  ["/dashboard/analytics-setup", "/os/packs/analytics-setup/report"],
  ["/dashboard/brand-voice", "/os/packs/brand-voice/report"],
