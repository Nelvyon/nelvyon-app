...
const FEATURED: Record<PackId, PackElitePreset> = {
  ...
  [STRATEGY_PACK_ID]: {
    ...
    label: "StrategyDemo",
    sector: "local",
    tagline: "Plan estratégico 90d",
    intake: {
      business_name: "StrategyDemo",
      sector: "local",
      city: "Madrid",
      country: "ES",
      value_proposition: "Crecimiento con packs priorizados",
      primary_cta: "Ver plan",
      goals: ["leads", "revenue"],
      horizon_days: 90,
      tier: "professional",
    },
  ...
  [FUNNEL_GROWTH_PACK_ID]: {
    ...
    label: "FunnelDemo",
    sector: "ecommerce",
    tagline: "Funnel multi-step CRO",
    intake: {
      business_name: "FunnelDemo",
      sector: "ecommerce",
      city: "Barcelona",
      country: "ES",
      value_proposition: "Más conversión en el mismo tráfico",
      primary_cta: "Comprar",
      funnel_steps: 3,
      offer: "Envío gratis 48h",
      tier: "professional",
    },
    templates: SECTOR_TEMPLATES.ecommerce,
  },
  [RETENTION_PACK_ID]: {
    ...
    label: "RetentionDemo",
    sector: "saas_b2b",
    tagline: "Retención + churn rules",
    intake: {
      business_name: "RetentionDemo",
      sector: "saas_b2b",
      city: "Madrid",
      country: "ES",
      value_proposition: "Menos churn, más LTV",
      primary_cta: "Activar retención",
      cohort: "active_30d",
      channels: ["email", "crm"],
      loyalty_goal: "reduce_churn",
      tier: "professional",
    },
    templates: SECTOR_TEMPLATES.saas_b2b,
  },
