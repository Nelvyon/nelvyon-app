...
import { CtaCard } from "@/components/pa/bento-two/cards/cta-card";
import { Metrics } from "@/components/pa/bento-two/cards/metrics";
import { BrandsMarquee } from "@/components/pa/bento-two/cards/brands-marquee";
import { BottomMarquee } from "@/components/pa/bento-two/cards/bottom-marquee";
import { Quotes } from "@/components/pa/bento-two/cards/quotes";
  ...
  return (
    <section className="w-full">
      <Container className="flex flex-col gap-15 py-20 md:py-30">
        {!disabelHeader && <Header>Metodo NELVYON para escalar</Header>}
        <div
          className={cn(
