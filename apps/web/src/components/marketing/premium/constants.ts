...
export const PLANS = [
  {
    ...
    name: "Starter",
    price: 97,
    description: "Para negocios que empiezan a escalar con IA. Todo lo esencial en un solo lugar.",
    highlights: [
      "CRM hasta 1.000 contactos",
      "Email marketing (5.000 envíos/mes)",
      "SMS Marketing (500 SMS/mes)",
      "Formularios inteligentes",
      "Agenda y citas",
      "SEO básico — tracking 20 keywords",
      "Workflows automáticos (5 activos)",
      "Soporte email 48h",
    ],
    featured: false,
  },
  {
    ...
    highlights: [
      ...
      "Redes sociales — publicación multi-plataforma",
      "Google Ads + Meta Ads integrados",
      "SEO — keywords ilimitadas + auditoría",
      "Workflows ilimitados + IA",
      "Form Builder avanzado con embed",
      "Portal de cliente personalizado",
      "193 agentes IA por sector",
  ...
  },
  {
    ...
    name: "Agency",
    price: 797,
    description: "Para agencias y freelancers que gestionan múltiples clientes. White-label incluido.",
    highlights: [
      "Todo de Pro",
