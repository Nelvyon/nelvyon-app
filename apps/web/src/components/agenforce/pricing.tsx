        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "24px", maxWidth: "1100px", margin: "0 auto" }}>
          {plans.map((plan) => (
            <div key={plan.name} style={{
              ...
              border: plan.popular ? "2px solid #1a7fc4" : "1px solid #e8eef8",
              ...
              {plan.popular && (
                <div style={{
                  ...
                  background: "#1a7fc4", color: "#ffffff", fontSize: "12px", fontWeight: 700,
              ...
              <div style={{ marginBottom: "24px" }}>
                <p style={{ fontSize: "13px", fontWeight: 600, color: plan.popular ? "#4db8e8" : "#1a7fc4", marginBottom: "8px" }}>{plan.name}</p>
              ...
              <ul style={{ listStyle: "none", padding: 0, margin: "0 0 28px 0", display: "flex", flexDirection: "column", gap: "12px" }}>
                {plan.steps.map((step) => (
                  <li key={step} style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                    <IconCircleCheckFilled style={{ width: "18px", height: "18px", color: plan.popular ? "#4db8e8" : "#1a7fc4", flexShrink: 0 }} />
              ...
              <a href={plan.href} style={{
                ...
                background: plan.popular ? "#1a7fc4" : "transparent",
                border: plan.popular ? "none" : "2px solid #1a7fc4",
                color: plan.popular ? "#ffffff" : "#1a7fc4",
