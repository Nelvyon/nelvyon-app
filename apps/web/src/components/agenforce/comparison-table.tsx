    ...
    <section style={{ backgroundColor: "#f8faff", padding: "80px 0" }}>
      <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "0 24px" }}>
        <div style={{ textAlign: "center", marginBottom: "40px" }}>
          ...
          <h2 style={{ fontSize: "clamp(24px, 3vw, 36px)", fontWeight: 800, color: "#07122a", margin: "0 0 12px" }}>
            NELVYON frente a otras opciones
          </h2>
          <p style={{ fontSize: "15px", color: "#5a6a8a", margin: 0, maxWidth: "520px", marginLeft: "auto", marginRight: "auto" }}>
            ...
            <tbody>
              {rows.map((row, index) => (
                <tr key={row.feature} style={{ borderTop: "1px solid #e8eef8", backgroundColor: index % 2 === 0 ? "#ffffff" : "#fafbfd" }}>
                  ...
                  <td style={{ padding: "12px 16px", textAlign: "center", color: "#5a6a8a", fontSize: "14px" }}>{row.agencia}</td>
                  <td style={{ padding: "12px 16px", textAlign: "center", color: "#5a6a8a", fontSize: "14px" }}>{row.plataformas}</td>
                </tr>
              ))}
            </tbody>
          </table>
