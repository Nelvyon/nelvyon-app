          ...
          style={
            {
              ...
              "--gradient":
                variant === "white"
                  ...
                  : variant === "nelvyon"
                    ? `radial-gradient(circle, #0084ff 12%, transparent 22%),
                radial-gradient(circle at 40% 40%, #0047ab 8%, transparent 18%),
                repeating-conic-gradient(
                  from 236.84deg at 50% 50%,
                  #0084ff 0%,
                  #0047ab calc(33% / var(--repeating-conic-gradient-times)),
                  #0084ff calc(66% / var(--repeating-conic-gradient-times)),
                  #0047ab calc(100% / var(--repeating-conic-gradient-times))
                )`
