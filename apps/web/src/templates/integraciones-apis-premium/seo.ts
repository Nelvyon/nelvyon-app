...
import type { IntegracionPremiumPageSeoConfig } from "@/templates/integraciones-apis-premium/types";
...
export function buildIntegracionPremiumMetadata(seo: IntegracionPremiumPageSeoConfig): Metadata {
