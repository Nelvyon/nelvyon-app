...
import type { EmailMarketingPremiumPageSeoConfig } from "@/templates/email-marketing-premium/types";
...
export function buildEmailMarketingPremiumMetadata(seo: EmailMarketingPremiumPageSeoConfig): Metadata {
