...
import type { AdvisorPremiumPageSeoConfig } from "@/templates/advisor-empresarial-premium/types";
...
export function buildAdvisorPremiumMetadata(seo: AdvisorPremiumPageSeoConfig): Metadata {
