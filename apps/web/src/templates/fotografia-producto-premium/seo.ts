...
import type { FotografiaPremiumPageSeoConfig } from "@/templates/fotografia-producto-premium/types";
...
export function buildFotografiaPremiumMetadata(seo: FotografiaPremiumPageSeoConfig): Metadata {
