...
import type { OrmPremiumPageSeoConfig } from "@/templates/reputacion-orm-premium/types";
...
export function buildOrmPremiumMetadata(seo: OrmPremiumPageSeoConfig): Metadata {
