...
import type { BrandingPremiumPageSeoConfig } from "@/templates/branding-premium/types";
...
export function buildBrandingPremiumMetadata(seo: BrandingPremiumPageSeoConfig): Metadata {
