...
import type { PersonalDigitalPremiumPageSeoConfig } from "@/templates/personal-digital-premium/types";
...
export function buildPersonalDigitalPremiumMetadata(seo: PersonalDigitalPremiumPageSeoConfig): Metadata {
