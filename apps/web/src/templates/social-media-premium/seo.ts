...
import type { SocialMediaPremiumPageSeoConfig } from "@/templates/social-media-premium/types";
...
export function buildSocialMediaPremiumMetadata(seo: SocialMediaPremiumPageSeoConfig): Metadata {
