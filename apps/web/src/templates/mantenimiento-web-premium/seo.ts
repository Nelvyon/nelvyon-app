...
import type { MantenimientoPremiumPageSeoConfig } from "@/templates/mantenimiento-web-premium/types";
...
export function buildMantenimientoPremiumMetadata(seo: MantenimientoPremiumPageSeoConfig): Metadata {
