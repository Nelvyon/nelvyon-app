...
import type { FormacionPremiumPageSeoConfig } from "@/templates/formacion-capacitacion-premium/types";
...
export function buildFormacionPremiumMetadata(seo: FormacionPremiumPageSeoConfig): Metadata {
