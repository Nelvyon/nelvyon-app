...
import type { CanalesPremiumPageSeoConfig } from "@/templates/canales-comunicaciones-premium/types";
...
export function buildCanalesPremiumMetadata(seo: CanalesPremiumPageSeoConfig): Metadata {
