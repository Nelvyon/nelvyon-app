...
import type { VideoPremiumPageSeoConfig } from "@/templates/video-multimedia-premium/types";
...
export function buildVideoPremiumMetadata(seo: VideoPremiumPageSeoConfig): Metadata {
