...
import type { DisenoPremiumPageSeoConfig } from "@/templates/diseno-grafico-premium/types";
...
export function buildDisenoPremiumMetadata(seo: DisenoPremiumPageSeoConfig): Metadata {
