...
import type { EcommercePremiumSeoConfig } from "@/templates/ecommerce-premium/types";
...
export function buildEcommercePremiumMetadata(seo: EcommercePremiumSeoConfig): Metadata {
