...
import type { ContenidoPremiumPageSeoConfig } from "@/templates/contenido-copywriting-premium/types";
...
export function buildContenidoPremiumMetadata(seo: ContenidoPremiumPageSeoConfig): Metadata {
