...
import type { AutomatizacionPremiumPageSeoConfig } from "@/templates/consultoria-automatizacion-premium/types";
...
export function buildAutomatizacionPremiumMetadata(seo: AutomatizacionPremiumPageSeoConfig): Metadata {
