...
import type { InmersivoPremiumPageSeoConfig } from "@/templates/3d-inmersivo-premium/types";
...
export function buildInmersivoPremiumMetadata(seo: InmersivoPremiumPageSeoConfig): Metadata {
