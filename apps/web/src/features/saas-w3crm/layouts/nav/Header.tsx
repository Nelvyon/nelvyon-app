...
import { IMAGES, SVGICON } from "@/features/saas-w3crm/constant/theme";
import Image from "next/image";


const NotificationBlog = ({ classChange }: { classChange?: string }) => {
	return (
		<>
			<li>
				<div className="timeline-panel">
					<div className="media me-2">
						<Image alt="images" width={50} src={IMAGES.Avatar} />
					</div>
...
const Header = ({ onNote }: HeaderProps) => {
					...
					<div className="collapse navbar-collapse justify-content-between">
						...
						<ul className="navbar-nav header-right">
							<Dropdown as="li" className="nav-item dropdown notification_dropdown ">
								<Dropdown.Toggle variant="" as="div" className="nav-link   i-false c-pointer" role="button">
								...
								<Dropdown.Menu className="dropdown-menu-end" align="end">
									<div className="widget-timeline dz-scroll style-1 p-3  height370" id="DZ_W_TimeLine02">
										<ul className="timeline">
											<li>
												<div className="timeline-badge primary" />
												<Link className="timeline-panel c-pointer text-muted" href="#" scroll={false}>
							...
							<Dropdown as="li" className="nav-item dropdown notification_dropdown">
								...
								<Dropdown.Menu align="end" className="mt-2 dropdown-menu dropdown-menu-end">
									...
									<Link className="all-notification" href="#" scroll={false}>
										...
										<div className="card border-0 mb-0">
											<div className="card-header py-2">
												<div className="products">
													<Image src={IMAGES.Tab1} className="avatar avatar-md" alt="" />
													<div>
														<h6>Thomas Fleming</h6>
											...
											<div className="card-body px-0 py-2">
												...
												<Link href="#" scroll={false} className="dropdown-item ai-icon ">
													{SVGICON.Message}{" "}
											...
											<div className="card-footer px-0 py-2">
												...
												<Link href="#" scroll={false} className="dropdown-item ai-icon ">
													<svg className="profle-logout" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" 
														fill="none" stroke="#ff7979" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
