...
import { setupAuthedSaas, mockDataPlaybooks, expectUnauthorizedApi, LOGIN_URL, gotoAwaitingApi } from "./fixtures";

async function gotoPlaybooksReady(page: import("@playwright/test").Page): Promise<void> {
  await gotoAwaitingApi(page, "/saas/playbooks", "/api/saas/data-playbooks");
}
